...
class TwitterClient(object):
    ...
    def get_tweets(self, query, count = 10):
        ...
        try:
            ...
            f = open("src/sentimenttweets.txt",'r') 
...
def main():
    ...
    """
    tweets = api.get_tweets(query = 'Trump', count = 400)
    print tweets
  ...
  #  print("Negative tweets percentage: {} %".format(100*len(ntweets)/len(tweets)))
   ...
   # print("Neutral tweets percentage: {} % \
    ...
    """
    tweets = api.get_justtweets(query = 'Trump', count = 9000)

    #split dataset into 60/40 train, test split
    tweets = tweets[0:int(len(tweets)*0.6)]
    test_tweets=tweets[int(len(tweets)*0.6)::]
    ...
    result = api.getSVMFeatureVL(tweets, fv)
    #print result['labels']
